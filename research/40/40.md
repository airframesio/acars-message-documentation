Label 40 (UM40) messages are a user defined message type. They are uplinks from ground stations to the plane. According to the icao's gold 2 edition and ICAO Doc 4444 it is a reserved message type.
